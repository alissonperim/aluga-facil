...
### Cadastro de Usuário
**Descrição**: Contratos são documentos que serão assinados digitalmente por duas partes, locador e locatário. O locador é a entidade `User` o locatário é a entidade `Renter`. Contratos devem conter;.z     o usuário, o locatário, o imóvel e os proprietários do imóvel que foram previamente registrados pelo locatário.

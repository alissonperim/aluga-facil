...
export class Migration1723769197869 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "properties" ("id" character varying(31) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "created_by" character varying(120), "updated_by" character varying(120), "deleted_by" character varying(120), "addressId" character varying(31) NOT NULL, "owners_ids" text NOT NULL, "renterId" character varying(31), "contractId" character varying(31), "dimension" numeric, "description" character varying(360), "rental_price" numeric NOT NULL, "type" "public"."properties_type_enum" NOT NULL, "insurance_required" boolean NOT NULL, "guarantor_required" boolean NOT NULL, CONSTRAINT "PK_2d83bfa0b9fcd45dee1785af44d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."owners_maritalstatus_enum" AS ENUM('single', 'married', 'divorced', 'widowed')`);
        await queryRunner.query(`CREATE TABLE "owners" ("id" character varying(31) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "created_by" character varying(120), "updated_by" character varying(120), "deleted_by" character varying(120), "name" character varying(120), "last_name" character varying(120), "phone_number" character varying(14) NOT NULL, "email" character varying(120) NOT NULL, "document" character varying(11) NOT NULL, "birth_date" date, "addressId" character varying NOT NULL, "properties_ids" text, "maritalStatus" "public"."owners_maritalstatus_enum" NOT NULL, CONSTRAINT "UQ_7f29c1ccae990d8dd6a865c6765" UNIQUE ("phone_number"), CONSTRAINT "UQ_df4ef717018c5dc7bd3f4ab0de5" UNIQUE ("email"), CONSTRAINT "UQ_dce1d2a570c1d8eb7db6e01f374" UNIQUE ("document"), CONSTRAINT "REL_11e60a57c5ab007f7d72823fc2" UNIQUE ("addressId"), CONSTRAINT "PK_42838282f2e6b216301a70b02d6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "contracts_fees_fees" ("contractsId" character varying(31) NOT NULL, "feesId" character varying(31) NOT NULL, CONSTRAINT "PK_7c6722bb8741d2964428b0d22cd" PRIMARY KEY ("contractsId", "feesId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "owners_properties_properties" ("ownersId" character varying(31) NOT NULL, "propertiesId" character varying(31) NOT NULL, CONSTRAINT "PK_a4c6acf8fda96892c90e905b41f" PRIMARY KEY ("ownersId", "propertiesId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."owners_maritalstatus_enum"`);

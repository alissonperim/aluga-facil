...
export class Migration1721181596919 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "contracts_fees_fees" ("contractsId" character varying NOT NULL, "feesId" character varying NOT NULL, CONSTRAINT "PK_7c6722bb8741d2964428b0d22cd" PRIMARY KEY ("contractsId", "feesId"))`,
    )
    ...
    await queryRunner.query(
      `CREATE TABLE "owners_properties_properties" ("ownersId" character varying NOT NULL, "propertiesId" character varying NOT NULL, CONSTRAINT "PK_a4c6acf8fda96892c90e905b41f" PRIMARY KEY ("ownersId", "propertiesId"))`,
    )
    await queryRunner.query(
